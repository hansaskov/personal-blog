...
<div style="display: flex; justify-content: space-between;">
    ...
    <Image alt={"Image without Ball"} src={image_without_ball_2} width={360} height={180}  style="width: 47.5%;"  />
</div>
...
<div style="display: flex; justify-content: space-between;">
    ...
    <Image alt={"Image without Ball"} src={image_kick_1} width={360} height={180}  style="width: 47.5%;"  />
</div>
...
<div style="display: flex; justify-content: space-between;">
    <Image alt={"Image without Ball"} src={image_kick_detect} />
</div>
